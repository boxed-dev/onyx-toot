...
export async function sendMessage(page: Page, message: string) {
  await page.locator("#toot-chat-input-textarea").click();
  await page.locator("#toot-chat-input-textarea").fill(message);
  await page.locator("#toot-chat-input-send-button").click();
  await page.waitForSelector('[data-testid="toot-ai-message"]');
